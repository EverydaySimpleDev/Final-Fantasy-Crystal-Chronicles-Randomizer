...
> **Chest Randomizer:** run `py ffcc_gui.py` for an all-in-one GUI
> (randomizer, chest editor, and file tools). For the full guide and the
> command-line tools, see [RANDOMIZER.md](RANDOMIZER.md). The sections below
> cover the original model/texture file parser.
